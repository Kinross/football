(function(){
    ...
    var htmlMessage = '<div id="no-html5"><h1>Whoops!</h1><h2>Your using an old browser, please update it to view this data visualisation.</h2><img style="display:block; margin-left: auto; margin-top: 1em; margin-right: auto; height: 9em;"  src="sad.gif" alt="Old browser"></div><style>body{background:white;}#no-html5 img {display: block;margin: 2em auto;}</style>';
